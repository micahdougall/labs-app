        ...
        <div class="flex justify-center mt-4 sm:items-center sm:justify-between">
            <div class="text-center text-sm text-gray-500 sm:text-left">
                <div class="flex items-center">
                    ...
                    <a href="https://canvas.swansea.ac.uk/courses/36410/files/3363239?module_item_id=1832134" class="ml-1 underline">
                        Lab Sheet
                    </a>
...
{{--                    </svg>--}}
                    ...
                    <a href="https://github.com/micahdougall/labs-app" class="ml-1 underline">
                        Code
                    </a>
                </div>
            </div>
...
{{--                Labs 2 using Laravel v{{ Illuminate\Foundation\Application::VERSION }} (PHP v{{ PHP_VERSION }})--}}
                Labs 2
            </div>
        </div>
    </div>
